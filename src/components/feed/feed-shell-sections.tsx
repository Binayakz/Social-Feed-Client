...
const stories = [
    ...
    {name: "Ryan Roslansky", image: "/assets/images/card_ppl2.png", own: false},
    {name: "Dylan Field", image: "/assets/images/card_ppl3.png", own: false},
    {name: "Steve Jobs", image: "/assets/images/card_ppl4.png", own: false},
];
...
const friends = [
    {name: "Steve Jobs", role: "CEO of Apple", image: "/assets/images/people1.png", status: "5 minute ago", active: false},
    {name: "Ryan Roslansky", role: "CEO of Linkedin", image: "/assets/images/people2.png", status: "online", active: true},
    {name: "Dylan Field", role: "CEO of Figma", image: "/assets/images/people3.png", status: "online", active: true},
    {name: "Steve Jobs", role: "CEO of Apple", image: "/assets/images/people1.png", status: "5 minute ago", active: false},
];

const events = [
    {title: "No more terrorism no more cry", day: "10", month: "Jul"},
    {title: "No more terrorism no more cry", day: "10", month: "Jul"},
];
const svg =
    [<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 24" fill="none" stroke="#666" strokeWidth="2"
             strokeLinecap="round" strokeLinejoin="round" className="feather feather-save">
...
const exploreItems = [
    {label: "Learning", tag: "New"},
    {label: "Insights"},
    {label: "Find friends"},
    {label: "Bookmarks"},
    {label: "Group"},
    {label: "Gaming", tag: "New"},
    {label: "Settings"},
    {label: "Save post"},
];
                            ...
                            {story.own ? (
                                ...
                                <div className="_feed_inner_public_story _b_radious6">
                                    <div className="_feed_inner_public_story_image">
                                        <Image src={story.image} alt={story.name} width={180} height={220} className="_public_story_img"/>
                                        <div className="_feed_inner_pulic_story_txt">
                                            <p className="_feed_inner_pulic_story_para">{story.name}</p>
                                        </div>
                                        <div className="_feed_inner_public_mini">
                                            <Image src="/assets/images/mini_pic.png" alt="" width={36} height={36} className="_public_mini_img"/>
                                        </div>
                                    </div>
                                </div>
                            )}
            ...
            <div className="_feed_inner_ppl_card_mobile _mar_b16">
                <div className="_feed_inner_ppl_card_area">
                    <ul className="_feed_inner_ppl_card_area_list">
                        {stories.map((story) => (
                            <li key={story.name} className="_feed_inner_ppl_card_area_item">
                                <span className="_feed_inner_ppl_card_area_link">
                                    <div className={story.own ? "_feed_inner_ppl_card_area_story" : "_feed_inner_ppl_card_area_story_active"}>
                                        <Image
                                            src={story.own ? "/assets/images/mobile_story_img.png" : "/assets/images/mobile_story_img1.png"}
                                            alt={story.name}
                                            width={62}
                                            height={62}
                                            className={story.own ? "_card_story_img" : "_card_story_img1"}
                                        />
                                        {story.own ? (
                                    ...
                                    <p className={story.own ? "_feed_inner_ppl_card_area_link_txt" : "_feed_inner_ppl_card_area_txt"}>
                                        {story.own ? story.name : story.name.split(" ")[0]}
                                    </p>
                                </span>
                            </li>
                        ))}
                ...
                <div className="_left_inner_area_explore _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                    ...
                    <ul className="_left_inner_area_explore_list">
                        {exploreItems.map((item, index) => (
                            <li key={item.label} className="_left_inner_area_explore_item _explore_item">
                                <a href="#0" className="_left_inner_area_explore_link">
                                    {svg[index]}
                                    {item.label}
                                </a>
                                {item.tag ? <span className="_left_inner_area_explore_link_txt">{item.tag}</span> : null}
                            </li>
                        ))}
                    </ul>
                </div>
                        ...
                        <div key={person.name} className="_left_inner_area_suggest_info">
                            <div className="_left_inner_area_suggest_info_box">
                                <div className="_left_inner_area_suggest_info_image">
                                    <Image src={person.image} alt={person.name} width={48} height={48} className="_info_img1"/>
                                </div>
                    ...
                    <div className="_right_inner_area_info_ppl">
                        <div className="_right_inner_area_info_box">
                            <div className="_right_inner_area_info_box_image">
                                <Image src={youMightLike.image} alt={youMightLike.name} width={56} height={56} className="_ppl_img"/>
                            </div>
                            ...
                            >
                                <div className="_feed_right_inner_area_card_ppl_box">
                                    <div className="_feed_right_inner_area_card_ppl_image">
                                        <Image src={friend.image} alt={friend.name} width={48} height={48} className="_box_ppl_img"/>
                                    </div>
